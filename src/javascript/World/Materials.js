...
export default class Materials
{
    ...
    setShades()
    {
        this.shades = {}
        this.shades.items = {}
        this.shades.indirectColor = '#1A1A2E'
        ...
        this.shades.items.beige.uniforms.matcap.value = this.resources.items.matcapMetalTexture
        ...
        //Arcade
        this.shades.items.arcade = new MatcapMaterial()
        this.shades.items.arcade.name = 'shadeArcade'
        this.shades.items.arcade.uniforms.matcap.value = this.resources.items.matcapArcadeBaseTexture
        this.items.arcade = this.shades.items.arcade
    ...
    setFloorShadow()
    {
        ...
        this.items.floorShadow.shadowColor = '#FF004D'
